                        ...
                        <Row gutter={24}>
                            <Col span={16}>
                                <Card title="레일 로봇 센서 현황(환경 정보)">
                                    <Row gutter={[16, 16]}>
                                        <Col span={8}>
                                            <div id="chart">
                                                <HighchartsReact Highcharts={Highcharts} options={this.options} brobot={false}/>
                                            </div>
                                        </Col>
                                        <Col span={8}>
                                            <div id="chart">
                                        ...
                                        <Col span={8}>
                                            <div id="chart">
                                                <HighchartsReact brobot={false} Highcharts={Highcharts} options={this.options}/>
                                            </div>
                                        </Col>
                                    </Row>
                                    <Row gutter={[16, 16]}>
                            ...
                            <Col span={8}>
                                ...
                                <Card title="레일 로봇 상태 추이">
                                    <HighchartsReact Highcharts={Highcharts} options={this.options_2}/>
                                </Card>
                            </Col>
                        </Row>
